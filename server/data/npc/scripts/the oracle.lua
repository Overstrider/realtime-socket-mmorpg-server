		...
		if(getPlayerLevel(cid) < parameters.level) then
			npcHandler:say('CHILD! COME BACK WHEN YOU HAVE GROWN UP!')
                    ...
                    if (voc == 1) or (voc == 2) then  -- sorc/druid
                       doPlayerAddItem(cid, 5124)
                       doPlayerAddItem(cid, 5127)
                       doPlayerAddItem(cid, 5128)
                       doPlayerAddItem(cid, 5123)
					   doPlayerAddItem(cid, 5129)
					   local bp = doPlayerAddItem(cid, 5122, 1) -- bp
                    ...
                    elseif (voc == 4) then  -- knight
					   ...
					   local bp = doPlayerAddItem(cid, 5122, 1) -- bp
						...
						doAddContainerItem(bp, 2554, 1) -- shovel
						doAddContainerItem(bp, 2789, 5) -- brown mushroom
						doAddContainerItem(bp, 5130, 1) -- clerical mace
						doAddContainerItem(bp, 5126, 1) -- barbarian axe
						doAddContainerItem(bp, 5125, 1) -- spike sword
                    end
