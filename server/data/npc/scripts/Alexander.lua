...
if msgcontains(msg, 'bp of sd') or msgcontains(msg, 'bp of sudden death rune') or msgcontains(msg, 'bp sd') then
	npcHandler:say('Do you want to buy a backpack of sudden death rune for 5000 gold coins?')
	talk_state = 6
	
		elseif msgcontains(msg, 'yes') and talk_state == 6 then
			if getPlayerMoney(cid) >= 5000 then
				brown_bp = doPlayerAddItem(cid, 2003, 1)
				doAddContainerItem(brown_bp, 2268, 7)
				doAddContainerItem(brown_bp, 2268, 7)
				doAddContainerItem(brown_bp, 2268, 7)
				doAddContainerItem(brown_bp, 2268, 7)
				doAddContainerItem(brown_bp, 2268, 7)
	...
	if msgcontains(msg, 'bp of uh') or msgcontains(msg, 'bp of ultimate healing rune') or msgcontains(msg, 'bp uh') then
	npcHandler:say('Do you want to buy a backpack of ultimate healing rune for 4000 gold coins?')
	talk_state = 7
	
		elseif msgcontains(msg, 'yes') and talk_state == 7 then
			if getPlayerMoney(cid) >= 4000 then
				brown_bp = doPlayerAddItem(cid, 2002, 1)
				doAddContainerItem(brown_bp, 2273, 7)
				doAddContainerItem(brown_bp, 2273, 7)
				doAddContainerItem(brown_bp, 2273, 7)
				doAddContainerItem(brown_bp, 2273, 7)
				doAddContainerItem(brown_bp, 2273, 7)
