...
elseif msgcontains(msg, 'spiritual') or msgcontains(msg, 'bless') then
	npcHandler:say("Here in the whiteflower temple you may receive all bless. But we must ask of you to sacrifice 100.000 gold. Are you still interested?", 1)
	talk_state = 1394
...
elseif talk_state == 1394 and msgcontains(msg, 'yes') then
	if doPlayerRemoveMoney(cid, 100000) == true then
		...
		npcHandler:say("So receive full bless.", 1)
