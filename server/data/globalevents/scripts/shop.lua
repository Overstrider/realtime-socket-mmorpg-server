            ...
            if isPlayer(cid) == TRUE then
                ...
                if full_weight <= free_cap then
                    ...
                    if received_item == RETURNVALUE_NOERROR then
                        doPlayerSendTextMessage(cid, SHOP_MSG_TYPE, 'Congratulations! You have received '.. add_item_name ..' from the Empera Shop. Please logout so your character can save.')
