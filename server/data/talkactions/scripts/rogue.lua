...
elseif getPlayerStorageValue(cid, 84274493) >= 1 then
	...
	doCreatureChangeOutfit(cid, {lookType = 240, lookHead = outfit.lookHead, lookBody = outfit.lookBody, lookLegs = outfit.lookLegs, lookFeet = outfit.lookFeet})
	else
	doCreatureChangeOutfit(cid, {lookType = 239, lookHead = outfit.lookHead, lookBody = outfit.lookBody, lookLegs = outfit.lookLegs, lookFeet = outfit.lookFeet})
	end
end
return false
end