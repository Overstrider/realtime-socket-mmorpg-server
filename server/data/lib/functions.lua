...
function getPlayerVipPoints(cid)
    local Info = db.storeQuery("SELECT `premium_points` FROM `accounts` WHERE `id` = " .. getPlayerAccountId(cid) .. "")
...
function getPpts(cid)
    local check6 = db.storeQuery("SELECT `premium_points` FROM `accounts` WHERE `id` = " .. getPlayerAccountId(cid) .. "")
...
db.executeQuery("UPDATE accounts SET premium_points = "..getPpts(cid).."+"..amount.." WHERE id = ".. getPlayerAccountId(cid)) end
function removePpts(cid,amount)
db.executeQuery("UPDATE accounts SET premium_points = "..getPpts(cid).."-"..amount.." WHERE id = ".. getPlayerAccountId(cid)(cid)) end
function setPpts(cid,value)
db.executeQuery("UPDATE accounts SET premium_points = "..value.." WHERE id = ".. getPlayerAccountId(cid)(cid)) end
